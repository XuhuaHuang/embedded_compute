...
// configuration step. It creates a namespace called `embedded_compute`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", embedded_compute::cmake::project_name, embedded_compute::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", embedded_compute::cmake::project_version);
      return EXIT_SUCCESS;
    }
